...
import georgieImage from "../assets/georgie.jpg";
  ...
  return (
    <div className={cn(
      ...
      >
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full overflow-hidden flex-shrink-0 mr-3">
                <img src={georgieImage} alt="Avatar" className="h-full w-full object-cover" />
              </div>
              <div>
                <div className="font-semibold">Georgie</div>
        ...
        {/* Content section with Intercom-like design */}
        <div className="p-4">
          ...
          <div className="flex gap-3 mb-3 items-start">
            <div className="flex-1">
              ...
              {/* Description - improved formatting with better line height */}
          ...
          <PaymentButton amount={99} buttonRef={paymentButtonRef} />
          
          {/* Removed security note as it's now on the button */}
        </div>
        
        {/* Message input area at bottom (for styling only) */}
        <div className="p-3 border-t border-gray-100 bg-gray-50 mt-0 flex items-center">
          <div 
            ...
            onClick={() => paymentButtonRef.current?.click()} // Trigger payment button click when message input is clicked
          >
            Your message...
